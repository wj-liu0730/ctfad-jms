...
from algo.Anomaly.ADAlgoClass import TransformerClsAlgo, TransformerClsAlgoConfig
...
class AllConfig:
    AlgoParams: TransformerClsAlgoConfig = dataclasses.field(default_factory=TransformerClsAlgoConfig)
...
@hydra.main(version_base=None, config_path="../config", config_name='Classification_Transformer')
def run(cfg: AllConfig) -> None:
    ...
    algo = TransformerClsAlgo(cfg.AlgoParams, dataset.input_shape, 1) # output probability
